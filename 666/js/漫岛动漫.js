...
"shouye": "1",
"fenlei": "日本动漫$/list/lm1_1#国产动漫$/list/lm2_1#欧美动漫$/list/lm3_1#剧场电影$/list/lm4_1", //网站列表的分类
"houzhui": ".html", //网站翻页链接的后缀

"shifouercijiequ": "1", //截取的列表数组是否需要二次截取，0不需要，1需要
"jiequqian": "class=\"mb", //不需要二次截取就填空
"jiequhou": "class=\"footer", //不需要二次截取就填空
"jiequshuzuqian": "class=\"li-hv", //截取的列表数组的前关键词,截取的关键词有 " 的用 \ 进行转义
